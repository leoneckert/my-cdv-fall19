...
let gaps = 20;
function tuesdayLocation  (d,i, set){
  console.log(set)
  return "translate (" + (150+(w/set.length*i)) + ", 50)";
}

function wednesdayLocation  (d,i, set){

  return "translate (" + (150+(w/set.length*i)) + ", 150)";
}

function thursdayLocation  (d,i, set){

  return "translate (" + (150+(w/set.length*i)) + ", 250)";
}

function fridayLocation  (d,i, set){

  return "translate (" + (150+(w/set.length*i)) + ", 350)";
}

function saturdayLocation  (d,i, set){

  return "translate (" + (150+(w/set.length*i)) + ", 450)";
}

function sundayLocation  (d,i, set){

  return "translate (" + (150+(w/set.length*i)) + ", 550)";
}
/////////////////////////////////////////////////////////////////////
